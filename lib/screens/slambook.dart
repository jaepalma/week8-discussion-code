...
@override
  Widget build(BuildContext context) {
    Stream<QuerySnapshot> friendsStream = context.watch<SlambookProvider>().friend1;
    return Scaffold(
              ...
              child: OutlinedButton(
                  ...
                  onPressed: () {
                    ...
                    if (_formKey.currentState!.validate()) {
                      ...
                      context.read<SlambookProvider>().addFriend(
                        Friend(userId: snapshot.data?.docs.length as int,
                        formValues: curr));
